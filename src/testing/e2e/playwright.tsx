...
export function describeScreenshotFuzz<Props>(
  ...
  const testConditional =
    // eslint-disable-next-line @typescript-eslint/unbound-method
    platforms && !platforms.includes(PLATFORM) ? test.skip : test.describe;

  testConditional(PLATFORM, () => {
    ...
    test(`${BROWSER}-${APPEARANCE}${viewWidth}`, async ({ mount }) => {
      ...
      await expect(component).toHaveScreenshot(matchScreenshot);
    });
  });
}
